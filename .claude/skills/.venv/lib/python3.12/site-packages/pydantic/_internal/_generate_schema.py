...
_VALIDATOR_F_MATCH: Mapping[
    ...
    ("before", "no-info"): lambda f,
    schema: core_schema.no_info_before_validator_function(f, schema),
    ("after", "no-info"): lambda f,
    schema: core_schema.no_info_after_validator_function(f, schema),
    ...
    schema: core_schema.with_info_before_validator_function(f, schema),
    ...
    schema: core_schema.with_info_wrap_validator_function(f, schema),
}

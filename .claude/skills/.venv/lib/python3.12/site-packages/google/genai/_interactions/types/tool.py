...
class ComputerUse(BaseModel):
    ...
    excluded_predefined_functions: Optional[List[str]] = FieldInfo(
        alias="excludedPredefinedFunctions", default=None
    )
...
class GoogleSearch(BaseModel):
    ...
    search_types: Optional[
        List[Literal["web_search", "image_search", "enterprise_web_search"]]
    ] = None

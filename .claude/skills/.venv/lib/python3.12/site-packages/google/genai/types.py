...
class Part(_common.BaseModel):
    ...
    def from_function_response(
        ...
        *,
        ...
        function_response = FunctionResponse(name=name, response=response, parts=parts)
...
class AuthConfig(_common.BaseModel):
    ...
    google_service_account_config: Optional[AuthConfigGoogleServiceAccountConfig] = (
...
ToolParallelAiSearchOrDict = Union[ToolParallelAiSearch, ToolParallelAiSearchDict]
...
VoiceConsentSignatureOrDict = Union[VoiceConsentSignature, VoiceConsentSignatureDict]
...
class GroundingChunkMaps(_common.BaseModel):
    ...
    uri: Optional[str] = Field(default=None, description="""The URI of the place.""")
...
class GroundingMetadata(_common.BaseModel):
    ...
    source_flagging_uris: Optional[list[GroundingMetadataSourceFlaggingUri]] = Field(
        default=None,
...
class GenerateContentResponse(_common.BaseModel):
    ...
    def executable_code(self) -> Optional[str]:
        ...
        if len(self.candidates) > 1 and not _response_executable_code_warning_logged:
            logging.warning(
                "Warning: there are multiple candidates in the response, returning"
        ...
        *,
        ...
        if (
            ...
            # may not be a valid json per stream response
                ...
                pass
        elif isinstance(response_schema, EnumMeta) and result._get_text() is not None:
...
RecontextImageSourceOrDict = Union[RecontextImageSource, RecontextImageSourceDict]
...
RecontextImageConfigOrDict = Union[RecontextImageConfig, RecontextImageConfigDict]
...
RecontextImageResponseOrDict = Union[RecontextImageResponse, RecontextImageResponseDict]
...
SegmentImageResponseOrDict = Union[SegmentImageResponse, SegmentImageResponseDict]
...
GenerateVideosSourceOrDict = Union[GenerateVideosSource, GenerateVideosSourceDict]


class VideoGenerationReferenceImage(_common.BaseModel):
    """A reference image for video generation."""

    image: Optional[Image] = Field(default=None, description="""The reference image.""")
...
class Operation(ABC):
    ...
    @classmethod
    @abstractmethod
    def from_api_response(cls, api_response: Any, is_vertex_ai: bool = False) -> Self:
...
class GcsDestination(_common.BaseModel):
    ...
    def _validate_gcs_path(self) -> "GcsDestination":
        if self.output_uri_prefix and not self.output_uri_prefix.startswith("gs://"):
            raise ValueError(
...
class PreferenceOptimizationDataStats(_common.BaseModel):
    ...
    score_variance_per_example_distribution: Optional[DatasetDistribution] = Field(
        default=None,
...
class SupervisedTuningDataStats(_common.BaseModel):
    ...
    user_input_token_distribution: Optional[SupervisedTuningDatasetDistribution] = (
        Field(
            default=None,
            description="""Output only. Dataset distributions for the user input tokens.""",
        )
    ...
    user_output_token_distribution: Optional[SupervisedTuningDatasetDistribution] = (
        Field(
            default=None,
            description="""Output only. Dataset distributions for the user output tokens.""",
        )
...
class TuningDataStats(_common.BaseModel):
    ...
    preference_optimization_data_stats: Optional[PreferenceOptimizationDataStats] = (
        Field(
            default=None,
...
class TuningDataStatsDict(TypedDict, total=False):
    ...
    preference_optimization_data_stats: Optional[PreferenceOptimizationDataStatsDict]
...
CancelTuningJobConfigOrDict = Union[CancelTuningJobConfig, CancelTuningJobConfigDict]
...
_GetDocumentParametersOrDict = Union[_GetDocumentParameters, _GetDocumentParametersDict]
...
DeleteDocumentConfigOrDict = Union[DeleteDocumentConfig, DeleteDocumentConfigDict]
...
class _ListDocumentsParameters(_common.BaseModel):
    ...
    config: Optional[ListDocumentsConfig] = Field(default=None, description="""""")
...
ListDocumentsResponseOrDict = Union[ListDocumentsResponse, ListDocumentsResponseDict]
...
_ImportFileParametersOrDict = Union[_ImportFileParameters, _ImportFileParametersDict]
...
RegisterFilesResponseOrDict = Union[RegisterFilesResponse, RegisterFilesResponseDict]
...
class BatchJobDestination(_common.BaseModel):
    ...
    inlined_embed_content_responses: Optional[list[InlinedEmbedContentResponse]] = (
        Field(
            default=None,
            description="""The responses to the requests in the batch. Returned when the batch was
      built using inlined requests. The responses will be in the same order as
...
class BatchJobDestinationDict(TypedDict, total=False):
    ...
    inlined_embed_content_responses: Optional[list[InlinedEmbedContentResponseDict]]
    """The responses to the requests in the batch. Returned when the batch was
      built using inlined requests. The responses will be in the same order as
      the input requests.
      """
...
BatchJobDestinationUnionDict = Union[BatchJobDestinationUnion, BatchJobDestinationDict]
...
ContentReferenceImageOrDict = Union[ContentReferenceImage, ContentReferenceImageDict]
...
class LiveServerMessage(_common.BaseModel):
    ...
    voice_activity_detection_signal: Optional[VoiceActivityDetectionSignal] = Field(
        default=None,
...
EmbedContentParametersOrDict = Union[EmbedContentParameters, EmbedContentParametersDict]

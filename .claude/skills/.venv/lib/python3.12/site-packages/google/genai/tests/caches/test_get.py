...
def test_different_cache_name_formats(client):
    if client._api_client.vertexai:
        ...
        assert response2
        response3 = client.caches.get(name="cachedContents/2164089915711684608")
        assert response3
        response4 = client.caches.get(name="2164089915711684608")
        assert response4
    else:
        response1 = client.caches.get(
            name="cachedContents/o239k1gxzz0juy9wqstndhncr85krehehf551hqh"
        ...
        assert response1
        response2 = client.caches.get(name="o239k1gxzz0juy9wqstndhncr85krehehf551hqh")
        assert response2

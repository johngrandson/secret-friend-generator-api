...
def _BatchJobDestination_to_vertex(
    ...
    if getv(from_object, ["inlined_embed_content_responses"]) is not None:
        raise ValueError(
            "inlined_embed_content_responses parameter is not supported in Vertex AI."
        )
...
def _BatchJob_from_vertex(
    ...
    if getv(from_object, ["completionStats"]) is not None:
        setv(to_object, ["completion_stats"], getv(from_object, ["completionStats"]))
...
class AsyncBatches(_api_module.BaseModule):
    ...
    async def cancel(
        ...
        *,
        ...
        await self._api_client.async_request("post", path, request_dict, http_options)

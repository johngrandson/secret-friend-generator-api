...
def _CreateFileSearchStoreParameters_to_mldev(
    ...
    if getv(from_object, ["config"]) is not None:
        _CreateFileSearchStoreConfig_to_mldev(getv(from_object, ["config"]), to_object)
...
def _DeleteFileSearchStoreParameters_to_mldev(
    ...
    if getv(from_object, ["config"]) is not None:
        _DeleteFileSearchStoreConfig_to_mldev(getv(from_object, ["config"]), to_object)
...
def _ImportFileOperation_from_mldev(
    ...
    if getv(from_object, ["response"]) is not None:
        setv(
            to_object,
            ["response"],
            _ImportFileResponse_from_mldev(getv(from_object, ["response"]), to_object),
        )
...
def _ListFileSearchStoresParameters_to_mldev(
    ...
    to_object: dict[str, Any] = {}
    if getv(from_object, ["config"]) is not None:
        _ListFileSearchStoresConfig_to_mldev(getv(from_object, ["config"]), to_object)
    ...
    def _upload_to_file_search_store(
        ...
        *,
        ...
        if self._api_client.vertexai:
            ...
            request_url_dict = request_dict.get("_url")
            if request_url_dict:
                path = "upload/v1beta/{file_search_store_name}:uploadToFileSearchStore".format_map(
                    request_url_dict
                )
            else:
        ...
        return_value = types.UploadToFileSearchStoreResumableResponse._from_response(
            response=response_dict,
            kwargs={
                "config": {
                    "response_schema": getattr(

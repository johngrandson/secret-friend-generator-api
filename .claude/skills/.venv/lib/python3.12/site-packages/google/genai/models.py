...
def _AuthConfig_to_mldev(
    ...
    if getv(from_object, ["google_service_account_config"]) is not None:
        raise ValueError(
            "google_service_account_config parameter is not supported in Gemini API."
        )
...
def _FunctionCallingConfig_to_mldev(
    ...
    if getv(from_object, ["stream_function_call_arguments"]) is not None:
        raise ValueError(
            "stream_function_call_arguments parameter is not supported in Gemini API."
        )
...
def _GenerateContentConfig_to_mldev(
    ...
    if getv(from_object, ["model_armor_config"]) is not None:
        raise ValueError("model_armor_config parameter is not supported in Gemini API.")
...
def _GenerateVideosConfig_to_mldev(
    ...
    if getv(from_object, ["last_frame"]) is not None:
        setv(
            ...
            _Image_to_mldev(getv(from_object, ["last_frame"]), to_object, root_object),
        )
    ...
    if getv(from_object, ["reference_images"]) is not None:
        setv(
            ...
            ["instances[0]", "referenceImages"],
            [
                _VideoGenerationReferenceImage_to_mldev(item, to_object, root_object)
                for item in getv(from_object, ["reference_images"])
            ],
        )
    ...
    if getv(from_object, ["webhook_config"]) is not None:
        setv(parent_object, ["webhookConfig"], getv(from_object, ["webhook_config"]))
...
def _GenerateVideosConfig_to_vertex(
    ...
    if getv(from_object, ["last_frame"]) is not None:
        setv(
            parent_object,
            ["instances[0]", "lastFrame"],
            _Image_to_vertex(getv(from_object, ["last_frame"]), to_object, root_object),
        )
    ...
    if getv(from_object, ["reference_images"]) is not None:
        setv(
            ...
            ["instances[0]", "referenceImages"],
            [
                _VideoGenerationReferenceImage_to_vertex(item, to_object, root_object)
                for item in getv(from_object, ["reference_images"])
            ],
        )
...
def _GeneratedImageMask_from_vertex(
    ...
    if getv(from_object, ["_self"]) is not None:
        setv(
            to_object,
            ["mask"],
            _Image_from_vertex(getv(from_object, ["_self"]), to_object, root_object),
        )
...
def _GeneratedVideo_from_vertex(
    ...
    if getv(from_object, ["_self"]) is not None:
        setv(
            to_object,
            ["video"],
            _Video_from_vertex(getv(from_object, ["_self"]), to_object, root_object),
        )
...
def _ImageConfig_to_mldev(
    ...
    if getv(from_object, ["person_generation"]) is not None:
        raise ValueError("person_generation parameter is not supported in Gemini API.")

    if getv(from_object, ["prominent_people"]) is not None:
        raise ValueError("prominent_people parameter is not supported in Gemini API.")

    if getv(from_object, ["output_mime_type"]) is not None:
        raise ValueError("output_mime_type parameter is not supported in Gemini API.")
...
def _ImageConfig_to_vertex(
    ...
    if getv(from_object, ["prominent_people"]) is not None:
        setv(to_object, ["prominentPeople"], getv(from_object, ["prominent_people"]))
...
def _Part_to_mldev(
    ...
    if getv(from_object, ["inline_data"]) is not None:
        setv(
            to_object,
            ["inlineData"],
            _Blob_to_mldev(getv(from_object, ["inline_data"]), to_object, root_object),
        )
...
def _Tool_to_mldev(
    ...
    if getv(from_object, ["parallel_ai_search"]) is not None:
        raise ValueError("parallel_ai_search parameter is not supported in Gemini API.")
...
class Models(_api_module.BaseModule):
    ...
    def _generate_content_stream(
        ...
        *,
        ...
        if config is not None and getattr(config, "should_return_http_response", None):
            raise ValueError(
                "Accessing the raw HTTP response is not supported in streaming methods."
            )
    ...
    def _embed_content(
        ...
        *,
        ...
        content: Optional[Union[types.ContentUnion, types.ContentUnionDict]] = None,
        ...
        if self._api_client.vertexai:
            ...
            endpoint_url = (
                "{model}:embedContent"
                if t.t_is_vertex_embed_content_model(parameter_model.model)
                else "{model}:predict"

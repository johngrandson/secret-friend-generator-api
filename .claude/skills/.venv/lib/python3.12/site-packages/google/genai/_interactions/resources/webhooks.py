...
class WebhooksResource(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        if not api_version:
            raise ValueError(
                f"Expected a non-empty value for `api_version` but received {api_version!r}"
            )
        return self._post(
    ...
    def update(
        ...
        *,
        ...
        return self._patch(
            path_template(
                "/{api_version}/webhooks/{id}", api_version=api_version, id=id
            ),
            body=maybe_transform(
                {
                    "subscribed_events": subscribed_events,
    ...
    def ping(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/{api_version}/webhooks/{id}:ping", api_version=api_version, id=id
            ),

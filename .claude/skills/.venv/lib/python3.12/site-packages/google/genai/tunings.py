...
def _CreateTuningJobConfig_to_mldev(
    ...
    if getv(from_object, ["pre_tuned_model_checkpoint_id"]) is not None:
        raise ValueError(
            "pre_tuned_model_checkpoint_id parameter is not supported in Gemini API."
        )
    ...
    if getv(from_object, ["custom_base_model"]) is not None:
        raise ValueError("custom_base_model parameter is not supported in Gemini API.")
    ...
    if getv(from_object, ["evaluation_config"]) is not None:
        raise ValueError("evaluation_config parameter is not supported in Gemini API.")
    ...
    if getv(from_object, ["base_teacher_model"]) is not None:
        raise ValueError("base_teacher_model parameter is not supported in Gemini API.")
    ...
    if getv(from_object, ["encryption_spec"]) is not None:
        raise ValueError("encryption_spec parameter is not supported in Gemini API.")
...
def _TuningJob_from_vertex(
    ...
    if getv(from_object, ["customBaseModel"]) is not None:
        setv(to_object, ["custom_base_model"], getv(from_object, ["customBaseModel"]))
...
class Tunings(_api_module.BaseModule):
    def _get(
        ...
        *,
        ...
        if self._api_client.vertexai:
            response_dict = _TuningJob_from_vertex(response_dict, None, parameter_model)

        if not self._api_client.vertexai:
            response_dict = _TuningJob_from_mldev(response_dict, None, parameter_model)

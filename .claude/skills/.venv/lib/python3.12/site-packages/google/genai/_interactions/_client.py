...
class GeminiNextGenAPIClient(SyncAPIClient):
    ...
    def _validate_headers(self, headers: Headers, custom_headers: Headers) -> None:
        ...
        if self.api_key and headers.get("x-goog-api-key"):
            return
        if custom_headers.get("x-goog-api-key") or isinstance(
            custom_headers.get("x-goog-api-key"), Omit
        ):
            return
    ...
    def _prepare_options(self, options: FinalRequestOptions) -> FinalRequestOptions:
        ...
        has_auth = headers.get("Authorization") or headers.get(
            "x-goog-api-key"
...
class AsyncGeminiNextGenAPIClient(AsyncAPIClient):
    ...
    def with_streaming_response(
        self,
    ) -> AsyncGeminiNextGenAPIClientWithStreamedResponse:
...
class AsyncGeminiNextGenAPIClientWithStreamedResponse:
    ...
    def interactions(
        self,
    ) -> interactions.AsyncInteractionsResourceWithStreamingResponse:

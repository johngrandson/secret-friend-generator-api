...
DeltaThoughtSummaryContent: TypeAlias = Annotated[
...
class DeltaFunctionResult(BaseModel):
    ...
    result: Union[
        List[DeltaFunctionResultResultFunctionResultSubcontentList], str, object
    ]
...
class DeltaMCPServerToolResult(BaseModel):
    ...
    result: Union[
        List[DeltaMCPServerToolResultResultFunctionResultSubcontentList], str, object
    ]

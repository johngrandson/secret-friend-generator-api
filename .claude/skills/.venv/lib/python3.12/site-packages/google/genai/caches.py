...
def _CreateCachedContentParameters_to_mldev(
    ...
    if getv(from_object, ["config"]) is not None:
        _CreateCachedContentConfig_to_mldev(getv(from_object, ["config"]), to_object)
...
def _CreateCachedContentParameters_to_vertex(
    ...
    if getv(from_object, ["config"]) is not None:
        _CreateCachedContentConfig_to_vertex(getv(from_object, ["config"]), to_object)
...
def _ListCachedContentsParameters_to_vertex(
    ...
    to_object: dict[str, Any] = {}
    if getv(from_object, ["config"]) is not None:
        _ListCachedContentsConfig_to_vertex(getv(from_object, ["config"]), to_object)
...
def _UpdateCachedContentParameters_to_mldev(
    ...
    if getv(from_object, ["config"]) is not None:
        _UpdateCachedContentConfig_to_mldev(getv(from_object, ["config"]), to_object)
...
def _UpdateCachedContentParameters_to_vertex(
    ...
    if getv(from_object, ["config"]) is not None:
        _UpdateCachedContentConfig_to_vertex(getv(from_object, ["config"]), to_object)

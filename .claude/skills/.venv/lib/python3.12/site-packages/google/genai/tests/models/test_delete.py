...
test_table: list[pytest_helper.TestTableItem] = [
    pytest_helper.TestTableItem(
        ...
        parameters=types._DeleteModelParameters(model="models/8533706666867163136"),
    ...
    pytest_helper.TestTableItem(
        ...
        parameters=types._DeleteModelParameters(model="tunedModels/generate-num-9598"),
...
async def test_async_delete_tuned_model(client):
    if client._api_client.vertexai:
        ...
        response = await client.aio.models.delete(model="tunedModels/generate-num-888")


@pytest.mark.asyncio
async def test_async_delete_model(client):
    if client._api_client.vertexai:
        response = await client.aio.models.delete(model="models/1071206899942162432")
    else:
        with pytest.raises(errors.ClientError) as e:

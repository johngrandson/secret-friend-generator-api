...
class AsyncGeminiNextGenAPIClientAdapter(
    _interactions.AsyncGeminiNextGenAPIClientAdapter
):
...
class AsyncClient:
    ...
    def _nextgen_client(self) -> AsyncGeminiNextGenAPIClient:
        ...
        http_client: Optional[httpx.AsyncClient] = self._api_client._async_httpx_client
    ...
    def _has_nextgen_client(self) -> bool:
        return (
            hasattr(self, "_nextgen_client_instance")
            and self._nextgen_client_instance is not None
        )

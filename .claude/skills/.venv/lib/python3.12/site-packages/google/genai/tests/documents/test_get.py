...
_INVALID_DOCUMENT_NAME = (
    "fileSearchStores/fr3l0ri2so25-a3r1ump9x821/documents/_invalid_document_name"
)
...
test_table: list[pytest_helper.TestTableItem] = [
    ...
    pytest_helper.TestTableItem(
        ...
        parameters=types._GetDocumentParameters(name=_NON_EXISTENT_DOCUMENT_NAME),
        exception_if_vertex="only supported in the Gemini Developer client",

...
def test_content():
    assert t.t_content(types.Content(parts=[types.Part(text="test")])) == types.Content(
        parts=[types.Part(text="test")]
    )


def test_content_dict():
    assert t.t_content({"role": "user", "parts": [{"text": "test"}]}) == types.Content(
        parts=[types.Part(text="test")], role="user"
    )
...
def test_string():
    assert t.t_content("test") == types.UserContent(parts=[types.Part(text="test")])

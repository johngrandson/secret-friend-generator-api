    ...
    def __init__(
        ...
        *,
        ...
        api_key = (
            ...
            else os.environ.get("ANTHROPIC_FOUNDRY_API_KEY")
        )
        resource = (
            resource
            if resource is not None
            else os.environ.get("ANTHROPIC_FOUNDRY_RESOURCE")
        )
        base_url = (
            base_url
            if base_url is not None
            else os.environ.get("ANTHROPIC_FOUNDRY_BASE_URL")
        )
...
class AsyncAnthropicFoundry(
    BaseFoundryClient[httpx.AsyncClient, AsyncStream[Any]], AsyncAnthropic
):
    @overload
    def __init__(
        self,

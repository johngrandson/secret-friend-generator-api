...
from ...resources.beta.messages import (
...
class AnthropicBedrockMantle(
    BaseMantleClient[httpx.Client, Stream[Any]], SyncAPIClient
):
    messages: Messages
    beta: MantleBeta
    ...
    def __init__(
        ...
        *,
        ...
        resolved_api_key, resolved_base_url, use_sigv4, merged_headers = (
...
class AsyncAnthropicBedrockMantle(
    BaseMantleClient[httpx.AsyncClient, AsyncStream[Any]], AsyncAPIClient
):

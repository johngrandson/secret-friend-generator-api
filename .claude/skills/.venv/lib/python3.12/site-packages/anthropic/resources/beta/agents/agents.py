...
from ....types.beta.beta_managed_agents_url_mcp_server_params import (
        ...
        return self._get(
            ...
            options=make_request_options(
                ...
                query=maybe_transform(
                    {"version": version}, agent_retrieve_params.AgentRetrieveParams
                ),
            ),
            cast_to=BetaManagedAgentsAgent,
        )
...
class AsyncAgents(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        BetaManagedAgentsAgent, AsyncPageCursor[BetaManagedAgentsAgent]
    ]:
        """
        List Agents

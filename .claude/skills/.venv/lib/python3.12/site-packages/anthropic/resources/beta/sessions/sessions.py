...
from ....types.beta.beta_managed_agents_deleted_session import (
...
class Sessions(SyncAPIResource):
    ...
    def archive(
        ...
        *,
        ...
        return self._post(
            path_template(
                "/v1/sessions/{session_id}/archive?beta=true", session_id=session_id
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,
...
class AsyncSessions(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        BetaManagedAgentsSession, AsyncPageCursor[BetaManagedAgentsSession]
    ]:
        """
        List Sessions

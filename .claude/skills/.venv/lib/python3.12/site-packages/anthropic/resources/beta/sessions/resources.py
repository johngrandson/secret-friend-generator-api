...
from ....types.beta.sessions.beta_managed_agents_file_resource import (
    BetaManagedAgentsFileResource,
)
from ....types.beta.sessions.beta_managed_agents_session_resource import (
    BetaManagedAgentsSessionResource,
)
from ....types.beta.sessions.beta_managed_agents_delete_session_resource import (
    ...
    def list(
        ...
        *,
        ...
        return self._get_api_list(
            path_template(
                "/v1/sessions/{session_id}/resources?beta=true", session_id=session_id
            ),
...
class AsyncResources(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        BetaManagedAgentsSessionResource,
        AsyncPageCursor[BetaManagedAgentsSessionResource],
    ]:
        """
        List Session Resources

...
from ....types.beta.vaults import (
    credential_list_params,
    credential_create_params,
    credential_update_params,
)
from ....types.anthropic_beta_param import AnthropicBetaParam
from ....types.beta.vaults.beta_managed_agents_credential import (
    BetaManagedAgentsCredential,
)
from ....types.beta.vaults.beta_managed_agents_deleted_credential import (
...
class Credentials(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        if not vault_id:
            raise ValueError(
                f"Expected a non-empty value for `vault_id` but received {vault_id!r}"
            )
        extra_headers = {
            **strip_not_given(
                {
        ...
        return self._post(
            path_template(
                "/v1/vaults/{vault_id}/credentials?beta=true", vault_id=vault_id
            ),
    ...
    def retrieve(
        ...
        *,
        ...
        if not credential_id:
            raise ValueError(
                f"Expected a non-empty value for `credential_id` but received {credential_id!r}"
            )
        extra_headers = {
            **strip_not_given(
                {
...
class AsyncCredentials(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        BetaManagedAgentsCredential, AsyncPageCursor[BetaManagedAgentsCredential]
    ]:
        """
        List Credentials

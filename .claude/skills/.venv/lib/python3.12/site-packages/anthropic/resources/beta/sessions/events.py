...
from ....types.beta.sessions.beta_managed_agents_event_params import (
    BetaManagedAgentsEventParams,
)
from ....types.beta.sessions.beta_managed_agents_session_event import (
    BetaManagedAgentsSessionEvent,
)
from ....types.beta.sessions.beta_managed_agents_send_session_events import (
    BetaManagedAgentsSendSessionEvents,
)
from ....types.beta.sessions.beta_managed_agents_stream_session_events import (
        ...
        *,
        ...
        extra_headers = {
            **strip_not_given(
                {
                    "anthropic-beta": ",".join(
                        chain((str(e) for e in betas), ["managed-agents-2026-04-01"])
                    )
                    if is_given(betas)
                    else not_given
                }
        ...
        return self._get_api_list(
            path_template(
                "/v1/sessions/{session_id}/events?beta=true", session_id=session_id
            ),
...
class AsyncEvents(AsyncAPIResource):
    ...
    def list(
        ...
        *,
        ...
        BetaManagedAgentsSessionEvent, AsyncPageCursor[BetaManagedAgentsSessionEvent]
    ]:
        """
        List Events
        ...
        *,
        ...
        return await self._post(
            ...
            body=await async_maybe_transform(
                {"events": events}, event_send_params.EventSendParams
            ),
            options=make_request_options(
                extra_headers=extra_headers,
                extra_query=extra_query,

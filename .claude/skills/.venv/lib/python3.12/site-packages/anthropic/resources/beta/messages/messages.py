...
from ....types.beta.beta_cache_control_ephemeral_param import (
    BetaCacheControlEphemeralParam,
)
from ....types.beta.beta_context_management_config_param import (
...
class Messages(SyncAPIResource):
    ...
    def create(
        ...
        *,
        ...
        if (
            model in MODELS_TO_WARN_WITH_THINKING_ENABLED
            and thinking
    ...
    def parse(
        ...
        *,
        ...
        if is_given(output_format) and output_format is not None:
            ...
            merged_output_config = _merge_output_configs(
                output_config, transformed_output_format
            )
        else:
        ...
        *,
        ...
        if stream:
            return BetaStreamingToolRunner[ResponseFormatT](
                ...
                if is_given(compaction_control)
                else None,
            )
    ...
    def stream(
        ...
        *,
        ...
        return BetaMessageStreamManager(
            ...
            if is_dict(output_format)
            else cast(ResponseFormatT, output_format),
        )
...
def _validate_output_config_conflict(
    ...
    if (
        is_given(output_format)
        and output_format is not None
        and is_given(output_config)
    ):

...
class Anthropic(SyncAPIClient):
    ...
    def _validate_headers(self, headers: Headers, custom_headers: Headers) -> None:
        ...
        if headers.get("X-Api-Key") or isinstance(
            custom_headers.get("X-Api-Key"), Omit
        ):
            return

        if headers.get("Authorization") or isinstance(
            custom_headers.get("Authorization"), Omit
        ):
            return

...
def func_metadata(
    ...
    **critically** it also provides pre-parse helper to attempt to parse things from
    ...
    if isinstance(return_type_expr, type) and issubclass(
        return_type_expr, CallToolResult
    ):
...
def _create_model_from_class(
    cls: type[Any], type_hints: dict[str, Any]
) -> type[BaseModel]:
    ...
    return create_model(
        cls.__name__, __config__=ConfigDict(from_attributes=True), **model_fields
    )

...
class TestProcessFile:
    ...
    @patch("builtins.open", create=True)
    @patch("pathlib.Path.stat")
    def test_image_generation_with_aspect_ratio(
        self, mock_stat, mock_open, mock_client_class
    ):
...
class TestBatchProcessing:
    ...
    def test_batch_process_success(
        self, mock_client_class, mock_process, mock_find_key
    ):
...
if __name__ == "__main__":
    pytest.main(
        [__file__, "-v", "--cov=gemini_batch_process", "--cov-report=term-missing"]
    )

...
async def init_agents_registry() -> None:
    ...
    from src.domain.agents.tools.agents_mcp_tools import load_mcp_tools
    ...
    from src.domain.agents.apps.agents_analyst_app import create_analyst_app
    from src.domain.agents.apps.agents_interrupt_app import create_interrupt_app
    from src.domain.agents.apps.agents_rag_app import create_rag_app, init_rag_store
    from src.domain.agents.apps.agents_researcher_app import create_researcher_app
    from src.domain.agents.apps.agents_supervisor_app import create_supervisor_app
    from src.domain.agents.apps.agents_support_app import create_support_app
    from src.domain.agents.apps.agents_swarm_app import create_swarm_app

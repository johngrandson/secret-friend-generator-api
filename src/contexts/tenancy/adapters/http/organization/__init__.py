"""Organization HTTP adapter package.
...
re-exports `router` for use in `main.py`.
    ...
    from src.contexts.tenancy.adapters.http.organization import router
    app.include_router(router)
"""

from src.contexts.tenancy.adapters.http.organization.router import router
import src.contexts.tenancy.adapters.http.organization.routes  # noqa: F401 — triggers route registration

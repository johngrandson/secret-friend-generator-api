...
@isolated
def _relay_participant_created(sender: type, *, participant: ParticipantRead, **kwargs: object) -> None:
    dispatch_task(
...
@isolated
def _relay_participant_deleted(sender: type, *, participant_id: int, **kwargs: object) -> None:

...
from src.api.agents.agents_invoke_route import _last_message_content, router
...
async def test_invoke_returns_200_with_mocked_app(asgi_app):
    ...
    with patch("src.api.agents.agents_invoke_route.get_app", return_value=mock_app):

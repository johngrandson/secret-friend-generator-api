...
import src.domain.agents.tools.support.agents_support_escalation_tools as mod
...
async def test_escalate_to_human_calls_interrupt() -> None:
    with patch(
        "src.domain.agents.tools.support.agents_support_escalation_tools.interrupt",
        return_value="yes",
    ) as mock_int:

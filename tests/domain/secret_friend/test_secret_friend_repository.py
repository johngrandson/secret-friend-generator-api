...
def test_link_creates_new_secret_friend_record(db_session: Session, participant_fixture):
...
def test_link_upserts_existing_record_by_giver_id(db_session: Session, participant_fixture):
    giver = participant_fixture()
...
def test_link_two_different_givers_creates_two_records(db_session: Session, participant_fixture):
